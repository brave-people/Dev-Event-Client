      ...
      {props.cards.map((el) => {
        ...
        return (
          <div
            ...
            onClick={() => moveLink(el.link)}
            onMouseMove={setTransCard}
            onMouseLeave={setLeaveCard}
          >
            <div className={"card__tag"}>
              <img
                className={"card__tag__image"}
                src="https://s3.ap-northeast-2.amazonaws.com/cdn.cindy.com/dev-event/price-tag.svg"
                alt="tag"
              />
            ...
            <div className={"card__text"}>
              <p className={"card__text--date"}>
                {startDate} {el.endDate && <span> ~ {endDate}</span>}
              </p>
              <h2>{el.title}</h2>
              <p>{el.description}</p>
